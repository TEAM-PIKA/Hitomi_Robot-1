...
__help__ = """
Lazy to promote or demote someone? Want to see basic information about chat? \
All stuff about chatroom such as admin lists, pinning etc can be \
done easily using this bot.
...
*Admin only:*
 ...
 - /kickthefools : kick all inactive members from the group
 - /admincache : force refresh the admins list.

*Note*: To set group sticker set chat must needs to have min 105 members.

An example of setting group description :
`/setdes Hello, Everyone`: this sets the group description.
"""
